...
/******/ 	var hotCurrentHash = "15cd1154bff3079faeb6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardsJson = __webpack_require__(157);
	
	var _cardsJson2 = _interopRequireDefault(_cardsJson);
	
	// Our application
	
	var _GreetingCardApp = __webpack_require__(158);
	
	var _GreetingCardApp2 = _interopRequireDefault(_GreetingCardApp);
	
	_react2['default'].render(_react2['default'].createElement(_GreetingCardApp2['default'], { cards: _cardsJson2['default'] }), document.getElementById('mount'));
...
/***/ function(module, exports) {
	...
	module.exports = [
		{
			"message": "Hope you have a relaxed holiday",
			"image": "landscape"
		},
		{
			"message": "Summer is near",
			"image": "flower"
		},
		{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _normalizeCssNormalizeCss = __webpack_require__(164);
	
	var _normalizeCssNormalizeCss2 = _interopRequireDefault(_normalizeCssNormalizeCss);
	
	var _stylesStylesCss = __webpack_require__(168);
	...
	var _GreetingCard = __webpack_require__(159);
	
	var _GreetingCard2 = _interopRequireDefault(_GreetingCard);
	...
	var GreetingCardApp = (function (_React$Component) {
		function GreetingCardApp(props) {
			_classCallCheck(this, GreetingCardApp);
	
			_get(Object.getPrototypeOf(GreetingCardApp.prototype), 'constructor', this).call(this, props);
		...
		_inherits(GreetingCardApp, _React$Component);
	
		_createClass(GreetingCardApp, [{
			key: 'prevClicked',
			value: function prevClicked() {
				var newCardId = this.state.cardId === 0 ? this.props.cards.length - 1 : this.state.cardId - 1;
				this.setState({ cardId: newCardId });
			}
		}, {
			key: 'nextClicked',
			value: function nextClicked() {
				var newCardId = this.state.cardId === this.props.cards.length - 1 ? 0 : this.state.cardId + 1;
				this.setState({ cardId: newCardId });
			}
		}, {
			key: 'currentCard',
			value: function currentCard() {
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'GreetingCard' },
						_react2['default'].createElement(_GreetingCard2['default'], { card: this.currentCard() }),
						_react2['default'].createElement(_NavBar2['default'], { onPrev: this.prevClicked, onNext: this.nextClicked })
					),
		...
		return GreetingCardApp;
	})(_react2['default'].Component);
	
	exports['default'] = GreetingCardApp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CardImage = __webpack_require__(160);
	
	var _CardImage2 = _interopRequireDefault(_CardImage);
	
	var GreetingCard = (function (_React$Component) {
		function GreetingCard(props) {
			_classCallCheck(this, GreetingCard);
	
			_get(Object.getPrototypeOf(GreetingCard.prototype), 'constructor', this).call(this, props);
		}
	
		_inherits(GreetingCard, _React$Component);
	
		_createClass(GreetingCard, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(
					'div',
					...
					_react2['default'].createElement(
						'h1',
						{ className: 'GreetingCardTitle' },
						this.props.card.message
					),
					_react2['default'].createElement(_CardImage2['default'], { image: this.props.card.image })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesLandscapeJpg = __webpack_require__(161);
	
	var _imagesLandscapeJpg2 = _interopRequireDefault(_imagesLandscapeJpg);
	
	var _imagesFlowerJpg = __webpack_require__(162);
	
	var _imagesFlowerJpg2 = _interopRequireDefault(_imagesFlowerJpg);
	
	var _imagesSunsetJpg = __webpack_require__(163);
	
	var _imagesSunsetJpg2 = _interopRequireDefault(_imagesSunsetJpg);
	
	var IMAGES = {
		landscape: _imagesLandscapeJpg2['default'],
		flower: _imagesFlowerJpg2['default'],
		sunset: _imagesSunsetJpg2['default']
	};
	...
	var CardImage = (function (_React$Component) {
		function CardImage(props) {
			...
			_get(Object.getPrototypeOf(CardImage.prototype), 'constructor', this).call(this, props);
		}
		...
		_createClass(CardImage, [{
			...
			key: 'render',
			value: function render() {
				return _react2['default'].createElement('img', { className: 'Image', src: this.imageSrc() });
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "91c520b5644e5d32486e708a594c5f8c.jpg"

/***/ },
/* 162 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "6295f8623603e9f5acee647d4178549e.jpg"

/***/ },
/* 163 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "9f9f12d63c5cc9896d3f37865ca17be5.jpg"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "c9d8727d52a30ebe8ca2b27dbc93a9c4.jpg"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavButton = __webpack_require__(173);
	
	var _NavButton2 = _interopRequireDefault(_NavButton);
	
	// Use Image resources via require
	var Icons = {
		prev: __webpack_require__(174),
		next: __webpack_require__(172),
		prevHi: __webpack_require__(175),
		nextHi: __webpack_require__(176)
	};
		...
		_createClass(NavBar, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ className: 'NavBar' },
					_react2['default'].createElement(_NavButton2['default'], { hoverImage: Icons.prevHi, image: Icons.prev, onClick: this.props.onPrev }),
					_react2['default'].createElement(_NavButton2['default'], { hoverImage: Icons.nextHi, image: Icons.next, onClick: this.props.onNext })
				);
			}
		}]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavButton = (function (_React$Component) {
		...
		_createClass(NavButton, [{
			...
			key: "getImageDomNode",
			value: function getImageDomNode() {
				return _react2["default"].findDOMNode(this.refs.image);
			}
		}, {
			...
			key: "render",
			value: function render() {
				return _react2["default"].createElement("img", { src: this.state.hovered ? this.props.hoverImage : this.props.image,
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"

/***/ },
/* 175 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 176 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Use Image resources via require
	var Icons = {
		github: __webpack_require__(178),
		githubLight: __webpack_require__(179)
	};
	...
	var Footer = (function (_React$Component) {
		...
		_createClass(Footer, [{
			...
			key: 'componentDidMount',
			value: function componentDidMount() {
				this.footerNode = _react2['default'].findDOMNode(this.refs.footer);
			...
			key: 'render',
			value: function render() {
				var footerLineClassName = this.state.hovered ? 'FooterInner-FooterLine FooterInner-FooterLine-Selected' : 'FooterInner-FooterLine';
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ ref: 'footer', className: 'FooterInner', href: 'https://github.com/nilshartmann/react-webpack-example',
							title: 'Go to project GitHub page',
							target: '_blank' },
						_react2['default'].createElement('img', { src: this.state.hovered ? Icons.github : Icons.githubLight }),
						_react2['default'].createElement(
							'div',
							{ className: footerLineClassName },
							'A React Webpack Example'
						)
					)
				);
			}
